    ...
    <article style={{ padding: 'clamp(60px, 8vw, 120px) 0 var(--section-y)' }}>
      <div className="container-narrow">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 22, fontSize: 16, lineHeight: 1.75, color: 'var(--text)' }}>
          <p>This Privacy Policy describes how <strong>Urban Cairn Tech Solution</strong> ("we", "our", "us"), a sole-proprietorship MSME registered in Gujarat, India (Udyam: {company.udyam}), collects, uses, and shares information about you when you visit this website or engage our services.</p>
